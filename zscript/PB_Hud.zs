...
RENEGADE-ANDROiD
-PBWP melee, equipment, and addon weapon HUD additions
*/
...
{	
	...
	static const String PB_AmmoTypes[] =
	{
		...
		"ALISTFZG, FreezenadeAmmo, Blue, Equipment",
	...
	void DrawFullScreenStuff()
	{
		...
		if(plr) {
			...
			if(weap)
			{
				...
				// PBWP Melee Indicator
				if(CheckInventory("MeleeAxeSelected")) {
					PBHud_DrawImage("HFAXEY", (-93, -84), DI_SCREEN_RIGHT_BOTTOM | DI_ITEM_RIGHT_BOTTOM, scale: (1.25, 1.25));
					PBHud_DrawString(mBoldFont, Formatnumber(GetAmount("AxeDurability")), (-105, -96), DI_TEXT_ALIGN_RIGHT, Font.CR_UNTRANSLATED, scale: (0.8, 0.8));
				}
				else if(CheckInventory("MeleeCrowbarSelected")) {
					PBHud_DrawImage("HCRWBY", (-93, -84), DI_SCREEN_RIGHT_BOTTOM | DI_ITEM_RIGHT_BOTTOM, scale: (1.25, 1.25));
					PBHud_DrawString(mBoldFont, Formatnumber(GetAmount("CrowbarDurability")), (-105, -96), DI_TEXT_ALIGN_RIGHT, Font.CR_UNTRANSLATED, scale: (0.8, 0.8));
				}
				else if(CheckInventory("JohnnyHandsMeleeSelected")) {
					PBHud_DrawImage("HEXPLY", (-93, -84), DI_SCREEN_RIGHT_BOTTOM | DI_ITEM_RIGHT_BOTTOM, scale: (1.25, 1.25));
					PBHud_DrawString(mBoldFont, Formatnumber(GetAmount("ExplosiveHandCharges")), (-105, -96), DI_TEXT_ALIGN_RIGHT, Font.CR_UNTRANSLATED, scale: (0.8, 0.8));
				}
				else if(CheckInventory("BatonMeleeSelected")) {
					PBHud_DrawImage("HBATNY", (-93, -84), DI_SCREEN_RIGHT_BOTTOM | DI_ITEM_RIGHT_BOTTOM, scale: (1.25, 1.25));
					PBHud_DrawString(mBoldFont, Formatnumber(GetAmount("PB_Cell")), (-105, -96), DI_TEXT_ALIGN_RIGHT, Font.CR_UNTRANSLATED, scale: (0.8, 0.8));
				}
				else if(CheckInventory("SawMeleeSelected")) {
					PBHud_DrawImage("HCHNSY", (-93, -84), DI_SCREEN_RIGHT_BOTTOM | DI_ITEM_RIGHT_BOTTOM, scale: (1.25, 1.25));
					PBHud_DrawString(mBoldFont, Formatnumber(GetAmount("PB_Fuel")), (-105, -96), DI_TEXT_ALIGN_RIGHT, Font.CR_UNTRANSLATED, scale: (0.8, 0.8));
				}
				else if(CheckInventory("ClawGauntletMeleeSelected")) {
					PBHud_DrawImage("HCLAWY", (-93, -84), DI_SCREEN_RIGHT_BOTTOM | DI_ITEM_RIGHT_BOTTOM, scale: (1.25, 1.25));
					PBHud_DrawString(mBoldFont, Formatnumber(GetAmount("ClawCharges")), (-105, -96), DI_TEXT_ALIGN_RIGHT, Font.CR_UNTRANSLATED, scale: (0.8, 0.8));
				}
				else if(CheckInventory("ImpactorMeleeSelected")) {
					PBHud_DrawImage("HIMPAY", (-93, -84), DI_SCREEN_RIGHT_BOTTOM | DI_ITEM_RIGHT_BOTTOM, scale: (1.25, 1.25));
					PBHud_DrawString(mBoldFont, Formatnumber(GetAmount("ImpactorCharges")), (-105, -96), DI_TEXT_ALIGN_RIGHT, Font.CR_UNTRANSLATED, scale: (0.8, 0.8));
				}
				else if(CheckInventory("KatanaMeleeSelected")) {
					if(CheckInventory("HasDemonicKatana")) {
						PBHud_DrawImage("HKATAX", (-93, -84), DI_SCREEN_RIGHT_BOTTOM | DI_ITEM_RIGHT_BOTTOM, scale: (1.25, 1.25));
						PBHud_DrawString(mBoldFont, Formatnumber(GetAmount("PB_DTech")), (-105, -96), DI_TEXT_ALIGN_RIGHT, Font.CR_UNTRANSLATED, scale: (0.8, 0.8));
					}
					else {
						PBHud_DrawImage("HKTAY", (-93, -84), DI_SCREEN_RIGHT_BOTTOM | DI_ITEM_RIGHT_BOTTOM, scale: (1.25, 1.25));
						PBHud_DrawString(mBoldFont, Formatnumber(GetAmount("KatanaDurability")), (-105, -96), DI_TEXT_ALIGN_RIGHT, Font.CR_UNTRANSLATED, scale: (0.8, 0.8));
					}
				}
				else if(CheckInventory("PickAxeMeleeSelected")) {
					PBHud_DrawImage("HPICKY", (-93, -84), DI_SCREEN_RIGHT_BOTTOM | DI_ITEM_RIGHT_BOTTOM, scale: (1.25, 1.25));
					PBHud_DrawString(mBoldFont, Formatnumber(GetAmount("PickAxeDurability")), (-105, -96), DI_TEXT_ALIGN_RIGHT, Font.CR_UNTRANSLATED, scale: (0.8, 0.8));
				}
				else if(CheckInventory("SentinelHammerMeleeSelected")) {
					PBHud_DrawImage("HSENTY", (-93, -84), DI_SCREEN_RIGHT_BOTTOM | DI_ITEM_RIGHT_BOTTOM, scale: (1.25, 1.25));
					PBHud_DrawString(mBoldFont, Formatnumber(GetAmount("SentinelhammerCharges")), (-105, -96), DI_TEXT_ALIGN_RIGHT, Font.CR_UNTRANSLATED, scale: (0.8, 0.8));
				}
				else if(CheckInventory("HammerMeleeSelected")) {
					PBHud_DrawImage("HSLEDY", (-93, -84), DI_SCREEN_RIGHT_BOTTOM | DI_ITEM_RIGHT_BOTTOM, scale: (1.25, 1.25));
					PBHud_DrawString(mBoldFont, Formatnumber(GetAmount("HammerDurability")), (-105, -96), DI_TEXT_ALIGN_RIGHT, Font.CR_UNTRANSLATED, scale: (0.8, 0.8));
				}
				else if(CheckInventory("WrenchMeleeSelected")) {
					PBHud_DrawImage("HWRNCY", (-93, -84), DI_SCREEN_RIGHT_BOTTOM | DI_ITEM_RIGHT_BOTTOM, scale: (1.25, 1.25));
					PBHud_DrawString(mBoldFont, Formatnumber(GetAmount("WrenchDurability")), (-105, -96), DI_TEXT_ALIGN_RIGHT, Font.CR_UNTRANSLATED, scale: (0.8, 0.8));
				}
				else if(CheckInventory("MacheteMeleeSelected")) {
					PBHud_DrawImage("HCHETE", (-93, -84), DI_SCREEN_RIGHT_BOTTOM | DI_ITEM_RIGHT_BOTTOM, scale: (1.25, 1.25));
					PBHud_DrawString(mBoldFont, Formatnumber(GetAmount("MacheteDurability")), (-105, -96), DI_TEXT_ALIGN_RIGHT, Font.CR_UNTRANSLATED, scale: (0.8, 0.8));
				}
				...
				&& rw != "NemesisLMG" && rw != "PowerOverwhelming" && rw != "PB_MG42") 
                {
                    switch(Primary.GetClassName())
                    {
                        ...
                        case 'PB_DTech': 
                            ...
                            break;
                        case 'PBWP_ComplexAmmo':
                            weaponBarAccent = Font.CR_WHITE;
                            DrawAmmoBar("BARBACU1", "BARBACU2", "BARBACU3", "BAMBAR8", "ABAR9", "ABAR9", "AMMOIC9", Font.CR_WHITE);
                            break;
				...
				switch(weap.GetClassName())
				{
					...
					case 'NemesisLMG':
					{
						if(Primary) {
							...
							PBHud_DrawBar("ABAR9", "BGBARL", IntAmmo1, Primary.MaxAmount, (-122, -32), 0, 1, DI_SCREEN_RIGHT_BOTTOM | DI_ITEM_RIGHT_BOTTOM);
							PBHud_DrawString(mDefaultFont, Formatnumber(Primary.Amount), (-216, -48.75), DI_TEXT_ALIGN_RIGHT, Font.CR_WHITE);
						}
						if(Secondary) {
							PBHud_DrawImage("BARBACR2", (-73, -49), DI_SCREEN_RIGHT_BOTTOM | DI_ITEM_RIGHT_BOTTOM, playerBoxAlpha);
							PBHud_DrawBar("ABAR4", "BGBARL", IntAmmo2, Secondary.MaxAmount, (-111, -52), 0, 1, DI_SCREEN_RIGHT_BOTTOM | DI_ITEM_RIGHT_BOTTOM);
							PBHud_DrawString(mDefaultFont, Formatnumber(Secondary.Amount), (-205, -68.75), DI_TEXT_ALIGN_RIGHT, Font.CR_RED);
						}
						PBHud_DrawImage("AMMOIC9", (-76, -24), DI_SCREEN_RIGHT_BOTTOM | DI_ITEM_RIGHT_BOTTOM, 1, (28, 23));
						weaponBarAccent = Font.CR_WHITE;
						break;
					}
					case 'PowerOverwhelming':
					{
						if(Primary) {
							...
							PBHud_DrawBar("ABAR1", "BGBARL", IntAmmo1, Primary.MaxAmount, (-122, -32), 0, 1, DI_SCREEN_RIGHT_BOTTOM | DI_ITEM_RIGHT_BOTTOM);
							PBHud_DrawString(mDefaultFont, Formatnumber(Primary.Amount), (-216, -48.75), DI_TEXT_ALIGN_RIGHT, Font.CR_YELLOW);
						}
						if(Secondary) {
							PBHud_DrawImage("BARBACR2", (-73, -49), DI_SCREEN_RIGHT_BOTTOM | DI_ITEM_RIGHT_BOTTOM, playerBoxAlpha);
							PBHud_DrawBar("ABAR4", "BGBARL", IntAmmo2, Secondary.MaxAmount, (-111, -52), 0, 1, DI_SCREEN_RIGHT_BOTTOM | DI_ITEM_RIGHT_BOTTOM);
						...
						PBHud_DrawImage("AMMOIC1", (-76, -24), DI_SCREEN_RIGHT_BOTTOM | DI_ITEM_RIGHT_BOTTOM, 1, (28, 23));
						weaponBarAccent = Font.CR_YELLOW;
						break;
					}
					case 'PB_MG42':
					{
						...
						if(Secondary) {
							PBHud_DrawImage("BARBACR2", (-73, -49), DI_SCREEN_RIGHT_BOTTOM | DI_ITEM_RIGHT_BOTTOM, playerBoxAlpha);
							PBHud_DrawBar("ABAR4", "BGBARL", IntAmmo2, Secondary.MaxAmount, (-111, -52), 0, 1, DI_SCREEN_RIGHT_BOTTOM | DI_ITEM_RIGHT_BOTTOM);
							PBHud_DrawString(mDefaultFont, "HEAT", (-205, -68.75), DI_TEXT_ALIGN_RIGHT, Font.CR_RED);
						}
						PBHud_DrawImage("AMMOIC1", (-76, -24), DI_SCREEN_RIGHT_BOTTOM | DI_ITEM_RIGHT_BOTTOM, 1, (28, 23));
						weaponBarAccent = Font.CR_YELLOW;
						break;
				...
				if(CheckInventory("FragGrenadeSelected")) {
					...
					PBHud_DrawString(mBoldFont, Formatnumber(GetAmount("ShieldGrenadeAmmo")), (-47, -33), DI_TEXT_ALIGN_CENTER, Font.CR_ORANGE, scale: (0.8, 0.8));
				}
				else if(CheckInventory("VoidGrenadeSelected")) {
					PBHud_DrawImage("ALISTSHG", (-46, -45), DI_SCREEN_RIGHT_BOTTOM | DI_ITEM_CENTER, scale: (0.8, 0.8));
					PBHud_DrawString(mBoldFont, Formatnumber(GetAmount("VoidGrenadeAmmo")), (-47, -33), DI_TEXT_ALIGN_CENTER, Font.CR_PURPLE, scale: (0.8, 0.8));
				}
				else if(CheckInventory("SwarmerSelected")) {
					PBHud_DrawImage("ALISTSRM", (-46, -45), DI_SCREEN_RIGHT_BOTTOM | DI_ITEM_CENTER, scale: (0.8, 0.8));
					PBHud_DrawString(mBoldFont, Formatnumber(GetAmount("SwarmerAmmo")), (-47, -33), DI_TEXT_ALIGN_CENTER, Font.CR_ORANGE, scale: (0.8, 0.8));
				}
				else if(CheckInventory("LaserChargeSelected")) {
					PBHud_DrawImage("ALISTLSR", (-46, -45), DI_SCREEN_RIGHT_BOTTOM | DI_ITEM_CENTER, scale: (0.8, 0.8));
					PBHud_DrawString(mBoldFont, Formatnumber(GetAmount("LaserChargeAmmo")), (-47, -33), DI_TEXT_ALIGN_CENTER, Font.CR_RED, scale: (0.8, 0.8));
				}
					...
					PBHud_DrawString(mBoldFont, Formatnumber(GetAmount("AcidChargeAmmo")), (-47, -33), DI_TEXT_ALIGN_CENTER, Font.CR_GREEN, scale: (0.8, 0.8));
				}
				else if(CheckInventory("ElecPodSelected")) {
					PBHud_DrawImage("ALISTEPD", (-46, -45), DI_SCREEN_RIGHT_BOTTOM | DI_ITEM_CENTER, scale: (0.8, 0.8));
					PBHud_DrawString(mBoldFont, Formatnumber(GetAmount("ElecPodAmmo")), (-47, -33), DI_TEXT_ALIGN_CENTER, Font.CR_YELLOW, scale: (0.8, 0.8));
				}
				else if(CheckInventory("AxeSelected")) {
					PBHud_DrawImage("ALISTAXE", (-46, -45), DI_SCREEN_RIGHT_BOTTOM | DI_ITEM_CENTER, scale: (0.8, 0.8));
					PBHud_DrawString(mBoldFont, Formatnumber(GetAmount("PB_Axe")), (-47, -33), DI_TEXT_ALIGN_CENTER, Font.CR_RED, scale: (0.8, 0.8));
				}
				else if(CheckInventory("ShurikenSelected")) {
					PBHud_DrawImage("ALISTSHR", (-46, -45), DI_SCREEN_RIGHT_BOTTOM | DI_ITEM_CENTER, scale: (0.8, 0.8));
					PBHud_DrawString(mBoldFont, Formatnumber(GetAmount("ShurikenAmmo")), (-47, -33), DI_TEXT_ALIGN_CENTER, Font.CR_PURPLE, scale: (0.8, 0.8));
				}
				else if(CheckInventory("CaltropsSelected")) {
					PBHud_DrawImage("ALISTCTR", (-46, -45), DI_SCREEN_RIGHT_BOTTOM | DI_ITEM_CENTER, scale: (0.8, 0.8));
					PBHud_DrawString(mBoldFont, Formatnumber(GetAmount("CaltropsAmmo")), (-47, -33), DI_TEXT_ALIGN_CENTER, Font.CR_PURPLE, scale: (0.8, 0.8));
				}
				else if(CheckInventory("BeaconSelected")) {
					PBHud_DrawImage("ALISTBEA", (-46, -45), DI_SCREEN_RIGHT_BOTTOM | DI_ITEM_CENTER, scale: (0.8, 0.8));
					PBHud_DrawString(mBoldFont, Formatnumber(GetAmount("BeaconAmmo")), (-47, -33), DI_TEXT_ALIGN_CENTER, Font.CR_BLUE, scale: (0.8, 0.8));
				}
				else if(CheckInventory("FreezebotSelected")) {
					PBHud_DrawImage("ALISTFRB", (-46, -45), DI_SCREEN_RIGHT_BOTTOM | DI_ITEM_CENTER, scale: (0.8, 0.8));
					PBHud_DrawString(mBoldFont, Formatnumber(GetAmount("FreezeBotAmmo")), (-47, -33), DI_TEXT_ALIGN_CENTER, Font.CR_BLUE, scale: (0.8, 0.8));
				}
				else if(CheckInventory("FreezeGrenadeSelected")) {
					PBHud_DrawImage("ALISTFZG", (-46, -45), DI_SCREEN_RIGHT_BOTTOM | DI_ITEM_CENTER, scale: (0.8, 0.8));
					PBHud_DrawString(mBoldFont, Formatnumber(GetAmount("FreezenadeAmmo")), (-47, -33), DI_TEXT_ALIGN_CENTER, Font.CR_BLUE, scale: (0.8, 0.8));
				}
				else if(CheckInventory("HookSelected")) {
					PBHud_DrawImage("ALISTHOK", (-46, -45), DI_SCREEN_RIGHT_BOTTOM | DI_ITEM_CENTER, scale: (0.8, 0.8));
				}
