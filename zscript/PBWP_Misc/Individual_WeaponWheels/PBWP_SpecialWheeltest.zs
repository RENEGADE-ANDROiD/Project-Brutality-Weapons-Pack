Class Autocannon_Wheel : wheelinfocontainer
{
	...
	override void GetSpecials(in out array <PB_SpecialWheel_Mode> spw, actor requester)
	{
		...
		Autocannon_HEAT.img = "Graphics/Autocannon/HEATAutocannon.png";
		...
		Autocannon_HEIAP.img = "Graphics/Autocannon/HEIAPAutocannon.png";
		...
		Autocannon_AP.img = "Graphics/Autocannon/APAutocannon.png";
